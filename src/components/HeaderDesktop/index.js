...
export default class HeaderDesktop extends Component {
  state = { calenderIsSelected: false };

  onCalenderClicked = () => {
    this.setState({ calenderIsSelected: true });
    console.log(`Calender is clicked , ${this.state.calenderIsSelected}`);
  };
            ...
            <div className="header-wrap">
              <div className="form-row">
                <img
                  ...
                  id="date-picker"
                  onClick={evt => {
                    this.onCalenderClicked();
                    this.setState({ calenderIsSelected: false });
                  }}
                />
